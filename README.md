...
**[Live Demo →](https://loreleifanchiang-gif.github.io/airwin-japan-ccu/)**
...
Vanilla HTML/CSS · [Lucide Icons](https://lucide.dev) · No build step required — open `index.html` directly.
